...
public interface ConnectionPacketOutputListener extends Listener
{
	...
	/**
	 * Similar to {@link PacketOutputListener.PacketOutputEvent}, but also captures packets that are
	 * sent before the client has finished connecting to the server. Most hacks
	 * should use {@link PacketOutputListener.PacketOutputEvent} instead.
	 */
