...
import org.broulf.admin.events.LeftClickListener;
	...
	implements UpdateListener, LeftClickListener
{
	private final SliderSetting range =
		new SliderSetting("Range", 5, 1, 10, 0.05, SliderSetting.ValueDisplay.DECIMAL);
	...
	private void attack()
	{
		...
		// face entity
		RotationUtils.Rotation rotation = RotationUtils
