...
import org.broulf.admin.settings.FileSetting;
...
import org.broulf.admin.util.AutoBuildTemplate;
import org.broulf.admin.util.BlockUtils;
import org.broulf.admin.util.ChatUtils;
import org.broulf.admin.util.DefaultAutoBuildTemplates;
	...
	implements UpdateListener, RightClickListener, RenderListener
{
	...
	private final SliderSetting range = new SliderSetting("Range",
		"How far to reach when placing blocks.\n" + "Recommended values:\n"
			+ "6.0 for vanilla\n" + "4.25 for NoCheat+",
		6, 1, 10, 0.05, SliderSetting.ValueDisplay.DECIMAL);
