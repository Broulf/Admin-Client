...
import org.broulf.admin.events.CameraTransformViewBobbingListener;
	...
	CameraTransformViewBobbingListener, RenderListener
{
	...
	public void onEnable()
	{
		...
		Feature.EVENTS.add(CameraTransformViewBobbingListener.class, this);
	...
	public void onDisable()
	{
		...
		Feature.EVENTS.remove(CameraTransformViewBobbingListener.class, this);
	...
	public void onUpdate()
	{
		...
		Stream<MobEntity> stream =
			StreamSupport.stream(Feature.MC.world.getEntities().spliterator(), false)
	...
	private void renderBoxes(double partialTicks)
	{
		...
		for(MobEntity e : mobs)
		{
			...
			float f = Feature.MC.player.distanceTo(e) / 20F;
