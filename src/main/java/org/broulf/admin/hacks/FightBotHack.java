...
import org.broulf.admin.commands.PathCmd;
	...
	implements UpdateListener, RenderListener
{
	private final SliderSetting range = new SliderSetting("Range",
		"Attack range (like Killaura)", 4.25, 1, 6, 0.05, SliderSetting.ValueDisplay.DECIMAL);
	...
	private final SliderSetting distance = new SliderSetting("Distance",
		...
		3, 1, 6, 0.05, SliderSetting.ValueDisplay.DECIMAL);
