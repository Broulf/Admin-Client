 ...
 */
package org.broulf.admin.navigator;
...
public abstract class NavigatorScreen extends Screen
{
	...
	{
		AdminClient.INSTANCE.getGui().updateColors();
		float[] bgColor = AdminClient.INSTANCE.getGui().getBgColor();
		float opacity = AdminClient.INSTANCE.getGui().getOpacity();
