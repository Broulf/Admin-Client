...
import org.broulf.admin.RotationFaker;
...
public enum RotationUtils
{
	...
	{
		RotationFaker rotationFaker = AdminClient.INSTANCE.getRotationFaker();
	...
	public static double getAngleToLastReportedLookVec(Vec3d vec)
	{
		...
		IClientPlayerEntity player = AdminClient.IMC.getPlayer();
	...
	{
		Rotation needed = getNeededRotations(vec);
		return MathHelper.wrapDegrees(AdminClient.MC.player.yaw) - needed.yaw;
	}
