...
{
	private final ClientPlayerEntity player = AdminClient.MC.player;
	private final ClientWorld world = AdminClient.MC.world;
	
	public FakePlayerEntity()
	{
		super(AdminClient.MC.world, AdminClient.MC.player.getGameProfile());
